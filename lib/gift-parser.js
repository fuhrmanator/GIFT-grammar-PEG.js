...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c2 = function(text) { resetLastQuestionTextFormat(); return {type:"Description", title:null, stem:text, hasEmbeddedAnswers:false} },
      peg$c3 = "{",
      ...
      peg$c17 = function(left, right) { var matchPair = { 
              subquestion:{
      ...
      peg$c82 = function(stem) { setLastQuestionTextFormat(stem.format); // save format for question, for default of other non-formatted text
            return stem },
      ...
      peg$c112 = function(format, txt) { return {
