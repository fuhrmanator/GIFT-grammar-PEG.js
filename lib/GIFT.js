...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c8 = function(title, text) { var question = {id: questionId, tags: questionTags, type:"Description", title:title, stem:convertFormat(text, 'moodle'), hasEmbeddedAnswers:false};
      ...
      peg$c85 = peg$otherExpectation("Question stem"),
      peg$c86 = function(stem) { //setLastQuestionTextFormat(stem.format); // save format for question, for default of other non-formatted text
            return stem },
